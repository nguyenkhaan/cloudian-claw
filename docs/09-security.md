...
User guide: [git-credential-adapter.md](../goclaw/docs/git-credential-adapter.md).
Implementer guide: [credential-adapter-playbook.md](../goclaw/docs/credential-adapter-playbook.md).
